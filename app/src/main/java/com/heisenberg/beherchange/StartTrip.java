...
public class StartTrip extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public static final String[] places = new String[] {
            "Dorchester", "South Boston", "Trinity Church"
    };
...
//        });
        ...
        startTripButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LatLng southBos = new LatLng(42.337522,-71.049068);
                destn = southBos;
                place1 = "South Boston";
                ...
                else if(source_eT.getText().toString().equals("Dorchester") || destn_eT.getText().toString().equals("South Boston"))
                {
                    marker1 = mMap.addMarker(new MarkerOptions()
                            ...
                            .title("Dorchester"));
                    marker2 = mMap.addMarker(new MarkerOptions().position(southBos).title("South Boston"));
